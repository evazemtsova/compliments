...
вопросом — и получает короткое послание, написанное Claude на основе
его же ответов.
...
5. **Послание** — Claude собирает 1-2 предложения, опираясь на состояние,
...
│       └── OfferingStep.tsx      # loading / error / финальное послание
├── components/
...
случайным посланием из небольшого набора — это позволяет дизайнить
...
послание с той же картой. Кнопка «Завершить ритуал» очищает день.
